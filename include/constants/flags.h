...
#define FLAG_HIDDEN_ITEMS_ROUTE_101_METAGROSSITE             (FLAG_HIDDEN_ITEMS_START + 0x266) 
#define FLAG_HIDDEN_ITEMS_ROUTE_102_CHARIZARDITE_X           (FLAG_HIDDEN_ITEMS_START + 0x267) 
