...
#define FLAG_HIDDEN_ITEM_LITTLEROOT_LUCKY_EGG                (FLAG_HIDDEN_ITEMS_START + 0x264) 
#define FLAG_HIDDEN_ITEM_OLDALE_LUCARIONITE                  (FLAG_HIDDEN_ITEMS_START + 0x265) 
#define FLAG_HIDDEN_ITEM_ROUTE_101_METAGROSSITE              (FLAG_HIDDEN_ITEMS_START + 0x266) 
#define FLAG_HIDDEN_ITEM_ROUTE_102_CHARIZARDITE_X            (FLAG_HIDDEN_ITEMS_START + 0x267) 
#define FLAG_HIDDEN_ITEM_MS_VENUSAURITE                      (FLAG_HIDDEN_ITEMS_START + 0x268)
